...
[RegisterCharacter]
public class Crusader : ModCharacterTemplate<CrusaderCardPool, CrusaderRelicPool, CrusaderPotionPool>
{
    // 角色名称颜色
    public override Color NameColor => new(0.75f, 0.75f, 0.75f);
    // 能量图标轮廓颜色
    public override Color EnergyLabelOutlineColor => new(0.75f, 0.75f, 0.75f);
    // 地图绘制颜色
    public override Color MapDrawingColor => new(0.75f, 0.75f, 0.75f);
