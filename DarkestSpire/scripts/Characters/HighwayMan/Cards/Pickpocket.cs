...
public class Pickpocket : ModCardTemplate
{
    public Pickpocket() : base(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy, true)
    {
    }
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(3, ValueProp.Move), new GoldVar("FightBackGold", 5)];
