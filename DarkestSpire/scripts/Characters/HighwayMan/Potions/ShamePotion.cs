...
public class ShamePotion : ModPotionTemplate
{
    ...
    {
        await PowerCmd.Apply(choiceContext, UniquenessControl.GetRandom(DSPoolType.Buff).ToMutable(), Owner.Creature, 1, Owner.Creature, null);
    }
}