...
namespace DarkestSpire.EventCards;

public class DSEventCardPool : TypeListCardPoolModel
{
    private const string ImageRoot = $"{Entry.ResPath}/images/dseventcards";
    
    // 卡池的ID。必须唯一防撞车。
    public override string Title => "DSEventCard";
    public override string EnergyColorName => "GeneralCardEnergyColor";
