...
namespace DarkestSpire.TokenCards;

public class DSTokenCardPool : TypeListCardPoolModel
{
    private const string ImageRoot = $"{Entry.ResPath}/images/dstokencards";
    
    // 卡池的ID。必须唯一防撞车。
    public override string Title => "DSTokenCard";
