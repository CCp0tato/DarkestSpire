...
public class GeneralCardPool : TypeListCardPoolModel
{
    private const string ImageRoot = $"{Entry.ResPath}/images/generalcards";
    
    // 卡池的ID。必须唯一防撞车。
    public override string Title => "GeneralCard";
