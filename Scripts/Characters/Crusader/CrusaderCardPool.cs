...
{
    // 卡池的ID。必须唯一防撞车。
    public override string Title => "十字军";
    public override string EnergyColorName => "十字军";
    ...
    // 能量表盘文字轮廓颜色
    public override Color EnergyOutlineColor => new(0.75f, 0.75f, 0.75f);

    // 根据你使用的卡框决定使用哪个Material
    private static readonly Material? _poolFrameMaterial = MaterialUtils.CreateReplaceHueShaderMaterial(0f, 0f, 0f); // 如果你使用原版卡框，使用这个直接替换色调。
